        ...
        <>
                ...
                <div className='content-gap'>
                    ...
                    <div className='mt-10 flex items-center flex-col lg:flex-row'>
                        <div className='flex-1'>
                            ...
                            <p className='mb-4'>
                                Once the design was finalized, I brought it to life using React and TailwindCSS. While exploring animation options, I discovered <a href="https://lottiefiles.com/" target='__blank' className='text-orange normal-case tracking-wide underline underline-offset-4'>Lottiefiles</a> , which was a game-changer! I was pleased by how effortlessly Lottie allowed me to integrate high-quality animations into my project using lightweight JSON files. The ease of implementation with the lottie-react library made it simple to add dynamic elements without affecting performance. Using Lottie’s scroll-based triggers, I could create engaging, responsive animations that enhanced the user experience while maintaining a smooth development process.

                            </p>
                        </div>
                        <div className='relative flex-1 flex lg:flex-col'>
                            <Lottie animationData={lottieEx} className='mix-blend-luminosity opacity-85 lg:-translate-y-10' />
            ...
            <section className='content-w pb-20 md:pb-[10rem]'>
                <div className=''>
                    ...
                    <div className='mt-10'>
                        <p>Working on the CoreVault landing page helped me sharpen my design and development skills by creating a clean and responsive layout that highlights the platform's key features. I had to think critically about how to organize content in a way that looks good and works well across different devices. This project showed me how important it is to keep things simple, clear, and engaging to effectively promote a product.  </p>
                    </div>
                </div>
            </section>
        </>
